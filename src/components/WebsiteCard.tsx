...
export default function WebsiteCard({ website }: WebsiteCardProps) {
  ...
  return (
    <a
      ...
      className="group bg-white rounded-sm overflow-hidden shadow-sm transition-all duration-300 hover:shadow-lg hover:shadow-red-100/40 fade-in-up-animation flex flex-col h-full block"
    >
      {/* Image Container */}
      <div className="relative w-full aspect-video bg-gray-100 overflow-hidden block">
        {/* Loading Skeleton */}
        {!isLoaded && !hasError && (
        ...
        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center pointer-events-none">
          <div className="bg-white text-red-600 px-5 py-2.5 rounded-full font-bold flex items-center gap-2 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 shadow-xl pointer-events-auto">
            Kunjungi Website
